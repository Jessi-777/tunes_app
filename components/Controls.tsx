    ...
    <div className="mt-3 flex w-3/5 items-center justify-between">
      ...
      {item.playPause ? (
        <div
          ...
          className="box-content h-[36px] w-2 border-x-8 border-x-[#000] dark:border-x-white "
        />
      ) : (
        <div
          onClick={item.IsplayMusic}
          className="box-content h-0 w-0 border-y-[18px] border-l-[25px] border-y-transparent border-l-[#000] dark:border-l-white"
        />
      )}
      <svg
        width="30"
